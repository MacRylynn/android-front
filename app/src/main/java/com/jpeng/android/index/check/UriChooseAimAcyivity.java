...
public class UriChooseAimAcyivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(UriChooseAimAcyivity.this, e.toString(), Toast.LENGTH_LONG).show();
        }
        //动态创建组件
        createUI(list);
        //返回到检测主页
    ...
    private List<UriUserInfoVo> getUserList(String response) {
        ...
        if (userLisr.size() == 0) {
            Toast.makeText(UriChooseAimAcyivity.this, "您还没有录入家庭成员系信息，请前往设置中录入", Toast.LENGTH_LONG).show();
            return reslist;
        }
