...
public class UriSettingActivity extends Activity {
        ...
        logoff.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(UriSettingActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        //清除缓存，删除保存的原图
    ...
    private void logOffDialog() {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                cursor.close();
                Intent intent = new Intent(UriSettingActivity.this, UriLoginActivity.class);
                startActivity(intent);
                dialog.dismiss();
                Toast.makeText(UriSettingActivity.this, "注销成功", Toast.LENGTH_SHORT).show();
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (!TextUtils.isEmpty(fileName)) {
                    ...
                    ContentResolver contentResolver = UriSettingActivity.this.getContentResolver();//cutPic.this是一个上下文
                    String url = MediaStore.Images.Media.DATA + "='" + fileName + "'";
                    //删除图片
                    contentResolver.delete(uri, url, null);
                }
                dialog.dismiss();
                Toast.makeText(UriSettingActivity.this, "清除成功", Toast.LENGTH_SHORT).show();
            }
        });
        mDialog = builder.create();
        mDialog.show();
