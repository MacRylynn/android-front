package com.jpeng.android.tutorial;
 ...
 */
public class UriTutorialActivity extends Activity {
    /*用来记录录像存储路径*/
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        vedioStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(UriTutorialActivity.this, file.getPath(), Toast.LENGTH_LONG).show();
        ...
        vedioTest.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Toast.makeText(UriTutorialActivity.this, "kaiasdasd", Toast.LENGTH_LONG).show();
